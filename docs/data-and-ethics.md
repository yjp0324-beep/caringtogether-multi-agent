...
> The source code, prompts, and system configuration used to implement the role-differentiated multi-agent system are publicly available at https://doi.org/10.5281/zenodo.21359273. The authors do not have permission to share the participant data; therefore, conversational data, survey responses, interview materials, and other participant datasets are not publicly available and are not included in this repository.
